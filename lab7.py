...
import lab7info		# you need to initialize this file with your Tweet app info

# Fill these in in the twitter_info.py file
consumer_key = lab7info.consumer_key
consumer_secret = lab7info.consumer_secret
access_token = lab7info.access_token
access_token_secret = lab7info.access_token_secret
